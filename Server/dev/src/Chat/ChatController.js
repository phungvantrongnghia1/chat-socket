...
let ChatController = class ChatController {
    ...
    getMessage(req, friendId) {
        return req.interator.messageGet.execute(req, friendId);
    }
};
__decorate([
    routing_controllers_1.Post("/v1/users/friend/message"),
...
__decorate([
    routing_controllers_1.Get("/v1/users/friend/message/:friendId"),
    __param(0, routing_controllers_1.Req()), __param(1, routing_controllers_1.Param("friendId")),
    __metadata("design:type", Function),
